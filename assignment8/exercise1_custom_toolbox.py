...
def buffer_layer(input_gdb, input_layer, dist):
    ...
    output_layer = r"D:\jilli\Documents\ACC-RRCC\Spring_2025\GIS3005_GIS_Apps\programs\asgmt_1a\MyProject.gdb\\" + input_layer + "_buf"
...
def main():
    ...
    # Buffer cities
    input_gdb = r"D:\jilli\Documents\ACC-RRCC\Spring_2025\GIS3005_GIS_Apps\programs\data\Admin\Admin\AdminData.gdb\USA\\"
    ...
    # Get the project
    aprx = arcpy.mp.ArcGISProject(r"D:\jilli\Documents\ACC-RRCC\Spring_2025\GIS3005_GIS_Apps\programs\asgmt_1a\MyProject.aprx")
    map_doc = aprx.listMaps()[0]
    map_doc.addDataFromPath(rf"D:\jilli\Documents\ACC-RRCC\Spring_2025\GIS3005_GIS_Apps\programs\asgmt_1a\MyProject.gdb\{intersect_lyr_name}")
